    ...
    return (
        <div className='about-page'>
            ...
            <div className='about-wrapper'>
                ...
                <div className='about-grid'>
                    <img src={NorthBay2} alt='Club'/>
                    <p>Enthusiast Club of Off-Road and Street Bike Riders. We are actively involved with BLM and Forest Service land management. We Support Enduro & Cross Country Racing, Host Dual Sport, Street & Adventures Rides. Support local riding- Join a Club..!!!</p>
                </div>
            </div>
        </div>
    )
